<?php
	if($estado == 1){
		$sql_contar = "SELECT count(*) AS numrows FROM prestamos p, clientes c, usuarios u, usuarios uu, rutas r, departamento d WHERE c.id_cliente = p.id_clientes AND u.id_usuario = p.cobrador AND r.id_ruta = c.id_ruta AND d.id_departamento = r.id_departamento AND p.renovacion <> '' AND (p.fecha_inicial BETWEEN '$fecha1' AND '$fecha2') AND uu.id_usuario = p.usuario AND (p.id_clientes LIKE '%".$query."%' OR c.nombre LIKE '%".$query."%' OR r.nombre LIKE '%".$query."%' OR d.nombre LIKE '%".$query."%' OR u.nombre LIKE '%".$query."%')";
	...
	if($estado == 2){
		$sql_contar = "SELECT count(*) AS numrows FROM prestamos p, clientes c, usuarios u, usuarios uu, rutas r, departamento d WHERE c.id_cliente = p.id_clientes AND u.id_usuario = p.cobrador AND r.id_ruta = c.id_ruta AND d.id_departamento = r.id_departamento AND p.renovacion <> '' AND p.id_ruta = '$ruta' AND p.cobrador = '$cobrador' AND (p.fecha_inicial BETWEEN '$fecha1' AND '$fecha2') AND uu.id_usuario = p.usuario AND (p.id_clientes LIKE '%".$query."%' OR c.nombre LIKE '%".$query."%' OR r.nombre LIKE '%".$query."%' OR d.nombre LIKE '%".$query."%' OR u.nombre LIKE '%".$query."%')";
	...
	if($estado == 3){
		$sql_contar = "SELECT count(*) AS numrows FROM prestamos p, clientes c, usuarios u, usuarios uu, rutas r, departamento d WHERE c.id_cliente = p.id_clientes AND u.id_usuario = p.cobrador AND r.id_ruta = c.id_ruta AND d.id_departamento = r.id_departamento AND p.renovacion <> '' AND p.cobrador = '$cobrador' AND (p.fecha_inicial BETWEEN '$fecha1' AND '$fecha2') AND uu.id_usuario = p.usuario AND (p.id_clientes LIKE '%".$query."%' OR c.nombre LIKE '%".$query."%' OR r.nombre LIKE '%".$query."%' OR d.nombre LIKE '%".$query."%' OR u.nombre LIKE '%".$query."%')";
	...
	if($estado == 4){
		$sql_contar = "SELECT count(*) AS numrows FROM prestamos p, clientes c, usuarios u, usuarios uu, rutas r, departamento d WHERE c.id_cliente = p.id_clientes AND u.id_usuario = p.cobrador AND r.id_ruta = c.id_ruta AND d.id_departamento = r.id_departamento AND p.renovacion <> '' AND p.id_ruta = '$ruta' AND (p.fecha_inicial BETWEEN '$fecha1' AND '$fecha2') AND uu.id_usuario = p.usuario AND (p.id_clientes LIKE '%".$query."%' OR c.nombre LIKE '%".$query."%' OR r.nombre LIKE '%".$query."%' OR d.nombre LIKE '%".$query."%' OR u.nombre LIKE '%".$query."%')";
				...
				<tr>
					...
					<td>
						...
						<?php }else{ ?>
							...
							<a href="#" data-toggle="tooltip" data-placement="top" title="Click para ver el perfil del usuario" onclick="location.href='perfil_usuario.php?id=<?php print($row['USUARIO']); ?>'" style=text-decoration: none;">
					...
					<td width="120" align="center">
						<button type="button" class="btn btn-success btn-xs" onclick="location.href='detalle_prestamo.php?c=<?php echo $row[1]; ?>&id=<?php echo $row[0]; ?>'">
							Ver
						</button>
					</td>
				</tr>
