						...
						<div class="btn-group" role="group">
							<?php if($estado==1){ ?>
								...
								<?php
									...
									if($row_permisos['editar_prestamo']==1){
								?>
									<li role="separator" class="divider"></li>

									<li> <!-- Editar -->
										<a href="#" onclick="location.href='editar_prestamo.php?id=<?php echo $row[0]; ?>'" style="color: darkgreen; font-weight: bold;">
								...
								<?php
									...
									if($row_permisos['eliminar_prestamo']==1){
								?>
										<li role="separator" class="divider"></li>
										
										<li> <!-- Eliminar -->
											<a href="javascript:void(0)" onclick="location.href='eliminar_prestamo_true.php?a=3&eliminar=<?php echo $row[0]; ?>&cliente=<?php echo base64_encode($row[1]); //Cliente ?>'" style="color: red; font-weight: bold;">
