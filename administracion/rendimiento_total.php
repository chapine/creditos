        ...
        <div align="right" class="navegar_secciones">
            <div class="row" style="margin-left:0px;">
                <div class="btn-group btn-breadcrumb">
                    ...
                    <a href="seleccione_cobrador.php?a=3" class="btn btn-success">Seleccione un cobrador</a>
					...
					<div class="row">
						<div class="col col-md-12 ajustar5">
							<table class="table table-striped table-bordered" width="100%" style="margin-bottom: 0px;">
								<tbody>
									<tr>
										<td width="30%" align="right"><b>Porcentaje de avance de prestamos activos</b></td>
										<td width="70%"> 
											<?php
					...
					<div class="row">
						<div class="col col-md-12 ajustar5">
							<table class="table table-striped table-bordered" width="100%" style="margin-bottom: 0px;">
								<tbody>
									<tr>
										<td width="30%" align="right"><b>Monto prestado finalizado (+)</b></td>
										<td width="70%"><?php echo moneda($row8['monto_prestado_finalizado'], 'Q'); ?></td>
									</tr>
									<tr>
										<td align="right"><b>Monto prestamos activo (+)</b></td>
