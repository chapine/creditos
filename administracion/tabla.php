...
<div class="row">
	<div class="col-sm-3" style="padding-bottom: 15px;">
		<select class="form-control" id="as" name="as" onChange="load(1);">
			...
			<option value="all">Mostrar Todos registros</option>
		</select>
	</div>
...
<div class='outer_div'><div style="background: url(../images/cargando.gif) no-repeat center; min-height: 300px; width: 100%;"></div></div>
<!-- Carga de datos ajax aqui -->
