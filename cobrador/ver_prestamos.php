...
<head>
	<?php
		...
		$sql = "SELECT * FROM clientes WHERE id_cliente = $id AND cobrador = $usuario";
		...
		if($row==0){
			...
			$alert_titulo ="Error";
			$alert_mensaje ="El cliente que búsca no existe";
			$alert_icono ="error";
			$alert_boton = "danger";
			$alert_link = "principal.php";
		}
			...
			<div align="right" class="navegar_secciones">
				<div class="row" style="margin-left:0px;">
					<div class="btn-group btn-breadcrumb">
						...
						<a href="lista_clientes.php?a=1" class="btn btn-success">Clientes</a>
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<div class="btn-group pull-right">
						<a href="lista_clientes.php" class="btn btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Regresar</a>
					</div>
				...
				<div class="panel-body">
					<table class="table table-bordered" width="100%">
						<tr>
							...
							<td>
								<div class="has-success has-feedback">
									<input class="form-control" id="nombre" name="nombre" type="text" value="<?php echo Convertir($row['nombre']); ?>" disabled>
						...
						<tr>
							...
							<td>
								<div class="has-success has-feedback">
									<input class="form-control" id="telefono" name="telefono" type="text" value="<?php echo telefono($row['tel'], 'input'); ?>" disabled>
						...
						<tr>
							...
							<td>
								<div class="has-success has-feedback">
									<input class="form-control" id="celular" name="celular" type="text" value="<?php echo celular($row['cel'], 'input'); ?>" disabled>
				...
				<div class="panel-body">
					...
					<div class="alert alert-<?php if($rowP[12]==0){ echo 'success'; }else{ echo $color;}?>" role="alert">
						<div class="row">
							...
							<div class="col col-md-12" style=" padding-bottom: 5px;"><b>Cobrador:</b> <?php echo Convertir($rowU[4]); ?></div>
							<div class="col col-md-3">
								<?php echo '<b>'.$i.' - Total de prestamo: </b>'.moneda(($rowP[5]+$rowP[9]), 'Q'); ?>
							</div>
